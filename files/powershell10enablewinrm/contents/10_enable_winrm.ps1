...
New-Item -Path WSMan:\LocalHost\Listener -Transport HTTPS -Address * -CertificateThumbPrint (New-SelfSignedCertificate -CertstoreLocation Cert:\LocalMachine\My -DnsName '${newMachine.hostname}' -NotAfter (get-date).AddYears(6)).Thumbprint -Force
Chk $?
