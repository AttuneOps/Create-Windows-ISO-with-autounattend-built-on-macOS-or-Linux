...
* `{windowsWorkerDirectory}\build-winpe-iso\winimg\efi\microsoft\boot\efisys_noprompt.bin` - which does not have the "Press any key To boot from CD or DVD . . . ." prompt for UEFI boot methods.
